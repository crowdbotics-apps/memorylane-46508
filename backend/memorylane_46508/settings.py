"""
Django settings for memorylane_46508 project.
...
ROOT_URLCONF = 'memorylane_46508.urls'
...
WSGI_APPLICATION = 'memorylane_46508.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "memorylane_46508 API",
    "DESCRIPTION": "API documentation for memorylane_46508 App",
    "VERSION": "v1",
}
